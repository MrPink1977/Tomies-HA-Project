...
- Test the Reolink camera as a Freya voice input during the day; current prototype uses continuous RTSP audio, Wyoming Whisper, a "Hey Freya" transcript gate, and strict Home Assistant entity routing.
